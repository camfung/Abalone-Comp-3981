...
move = Move((7, 3), (7, 5), Direction.UP_RIGHT, Marble.BLACK, MarbleSelection.HORIZONTAL)
print(move)
game.set_move(Marble.BLACK, move)

move = Move((1,5), (3,5), Direction.DOWN_RIGHT, Marble.WHITE, MarbleSelection.BACKWARD_SLASH)
